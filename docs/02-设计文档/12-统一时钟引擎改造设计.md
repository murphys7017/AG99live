...
- app composition root 提供并持有唯一 `PlaybackTimelineRuntime`；adapter audio runtime 只提供 audio clock、queued segment sinks 和 SessionStore projection ports，不再向 app 暴露 timeline facade。
