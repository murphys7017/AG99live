...
非法事件。当前内部 trace 为 `performance_schedule_trace.v6`，外部 `engine.motion_intent.v4` 和
...
`performance_schedule_trace.v6`，外部 V4/V3 协议、Timeline、ParameterMixer 和 WebSDK 均未改变。
