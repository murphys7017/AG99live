...
非法事件。内部 trace 已升级到 `performance_schedule_trace.v4`，外部 `engine.motion_intent.v4` 和
`engine.parameter_plan.v3` 保持不变。

### 5.7 最近动作多样性已有 Prompt 侧首步，Director 侧未完成
