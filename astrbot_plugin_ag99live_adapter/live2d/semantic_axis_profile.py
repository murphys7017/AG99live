...
_AXIS_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "body_yaw": {
        ...
        "usage_notes": "Use with head_yaw to express body posture and emotion strength; keep smaller than head motion unless the pose is explicit.",
    ...
    "body_roll": {
        ...
        "usage_notes": "Use for sway, weight shift, confusion, teasing, or emotional follow-through.",
        "output_range": [-10.0, 10.0],
        "soft_range": [46.0, 54.0],
        "strong_range": [38.0, 62.0],
    },
