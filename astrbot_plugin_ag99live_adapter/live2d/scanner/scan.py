...
VOICE_FOLLOWING_TUNING: dict[str, dict[str, Any]] = {
    "roll": {
        "head": {"amplitude_ratio": 0.84, "follow_delay_ms": 0},
        "body": {"amplitude_ratio": 0.76, "follow_delay_ms": 160},
    },
    "yaw": {
        "head": {"amplitude_ratio": 0.72, "follow_delay_ms": 0},
        "body": {"amplitude_ratio": 0.70, "follow_delay_ms": 200},
    },
    "pitch": {
        "head": {"amplitude_ratio": 0.38, "follow_delay_ms": 0},
        "body": {"amplitude_ratio": 0.32, "follow_delay_ms": 150},
    },
}
    ...
    *,
    ...
    for motion in motions:
        for component in motion.get("components", []):
            ...
            polarity = _infer_parameter_action_polarity(
                component=component,
...
def _infer_parameter_action_polarity(
    *,
    component: dict[str, Any],
    channel_name: str,
) -> str:
