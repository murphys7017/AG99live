...
const SPEECH_HEAD_ENVELOPE_ATTACK_PER_SECOND = 10.0;
const SPEECH_HEAD_ENVELOPE_RELEASE_PER_SECOND = 3.4;
const SPEECH_BODY_ENVELOPE_ATTACK_PER_SECOND = 5.5;
const SPEECH_BODY_ENVELOPE_RELEASE_PER_SECOND = 2.4;
const SPEECH_HEAD_ACTIVITY_FLOOR = 0.42;
const SPEECH_AUDIO_GAIN_SPAN = 1.32;
const SPEECH_AUDIO_GAIN_MAX = 1.68;
const SPEECH_AUDIO_PITCH_GAIN_MAX = 1.25;
const SPEECH_BODY_ACTIVITY_FLOOR = 0.34;
const SPEECH_BODY_GAIN_SPAN = 1.0;
const SPEECH_BODY_GAIN_MAX = 1.18;
const SPEECH_VOICED_ENTER_THRESHOLD = 0.028;
const SPEECH_VOICED_EXIT_THRESHOLD = 0.012;
...
const SPEECH_AUDIO_EMPHASIS_MAX = 0.22;
const SPEECH_HEAD_EMPHASIS_GAIN = 0.38;
const SPEECH_BODY_EMPHASIS_GAIN = 0.24;
